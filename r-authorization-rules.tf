resource "azurerm_eventhub_namespace_authorization_rule" "listen" {
  ...
  name                = var.use_caf_naming ? azurecaf_name.eventhub_namespace_auth_rule["listen"].result : "listen-default"
...
resource "azurerm_eventhub_namespace_authorization_rule" "send" {
  ...
  name                = var.use_caf_naming ? azurecaf_name.eventhub_namespace_auth_rule["send"].result : "send-default"
  namespace_name      = azurerm_eventhub_namespace.eventhub.name
  resource_group_name = var.resource_group_name
...
resource "azurerm_eventhub_namespace_authorization_rule" "manage" {
  ...
  name                = var.use_caf_naming ? azurecaf_name.eventhub_namespace_auth_rule["manage"].result : "manage-default"
  namespace_name      = azurerm_eventhub_namespace.eventhub.name
  resource_group_name = var.resource_group_name
